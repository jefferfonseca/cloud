...
<head>
  ...
  <style>
    ...
    /* Estilos para modal de introducción */
    .modal {
      max-height: 80%;
    }
    /* Estilos para breadcrumbs, título, y progresos */
    #breadcrumbs {
      padding: 8px 12px;
      font-size: 14px;
...
<body>
  ...
  <script>
    ...
    $(document).ready(function () {
      ...
      function renderFiles(data, parent, currentPath) {
        ...
        data.forEach(function (item) {
          if (item.type === "folder") {
            ...
            // Para archivos, se agrega un botón "Abrir" que abre el archivo en una nueva pestaña
            let action = `<a href="${item.path}" target="_blank" class="btn purple">Abrir</a>`;
            let fileItem = `
              <div class="card">
      ...
      // Función para subir archivos (usada en input change y en drag & drop)
